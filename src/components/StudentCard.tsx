...
const StudentCard: React.FC<StudentCardProps> = ({ student, onClick }) => {
  return (
       ...
       <div className="relative w-[350px] sm:w-[400px] md:w-[450px] lg:w-[500px] h-[400px] rounded-md shadow-lg bg-gradient-to-tr from-[#a0b9df] to-[#097ebd]">
...
/>;
            ...
            <div className="mt-6 sm:mt-8">
              <div className="mt-4 sm:mt-8" onClick={onClick}>
                <button className="block w-[100px] sm:w-[120px] h-[30px] mx-auto mb-2 text-xs font-semibold border border-[#bbe3f8] rounded-full transition-colors duration-300 hover:bg-[#11759d] hover:text-white">
                  Details
                </button>
              </div>
            </div>
          ...
          <div className="float-left">
            <div className="w-[100px] sm:w-[120px] h-[90px] sm:h-[99px] bg-[#bbe3f8] text-center pt-6 sm:pt-7 transition-colors duration-300 hover:bg-[#6fccf1]">
              <span className="block text-base sm:text-lg font-semibold">{student.totalMark}</span>
              <span className="block text-xs"> Mark</span>
            </div>
            <div className="w-[100px] sm:w-[120px] h-[90px] sm:h-[99px] bg-[#bbe3f8] text-center pt-6 sm:pt-7 transition-colors duration-300 hover:bg-[#6fccf1] my-[1px]">
